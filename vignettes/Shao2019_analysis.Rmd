...
```
The overview plots shows that we can explain ~10% of the variation in a three-component model. That is quite low. The CORCONDIA for that number of components is ~50. A four-component model yields negative CORCONDIA values.
