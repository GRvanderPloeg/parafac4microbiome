...
# Make PARAFAC model
model = parafac(Fujita2023$data, nfac=3, nstart=10, verbose=FALSE)
...
# Make PARAFAC model
model = parafac(Shao2019$data, nfac=3, nstart=10, verbose=FALSE)
...
# Make PARAFAC model
model = parafac(vanderPloeg2024$data, nfac=2, nstart=10, verbose=FALSE)
