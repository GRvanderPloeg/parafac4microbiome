...
# Process count data
cube_cnt_scl = processDataCube(Fujita2023$data, sparsityThreshold=0.99, centerMode=1, scaleMode=2)

# Make PARAFAC model
model = parafac(cube_cnt_scl, nfac=3, nstart=10, ctol=1e-6, maxit=2500, verbose=FALSE)
...
# Make PARAFAC model
model = parafac(Shao2019$data, nfac=3, nstart=10, ctol=1e-6, maxit=2500, verbose=FALSE)
