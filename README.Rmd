...
## Documentation
A basic introduction to the package is given in `vignette("PARAFAC")` and modelling the example datasets are elaborated in their respective vignettes `vignette("Fujita2023")`, `vignette("Shao2019")` and `vignette("vanderPloeg2024")`.
