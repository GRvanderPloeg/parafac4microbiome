test_that("Output in metrics has the right shape", {
  ...
  output = assessNumComponents(processedFujita$data, minNumComponents=1, maxNumComponents=3, numRepetitions=5)
...
test_that("A nonsensical minNumComponents throws an error", {
  expect_error(assessNumComponents(Fujita2023$data, minNumComponents=-3, maxNumComponents=3, numRepetitions=5))
})
